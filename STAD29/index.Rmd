...
- 2024-12-30 12:45: what to expect:
  ...
  - [My plans](https://docs.google.com/spreadsheets/d/1I1PZOtqbzOJg0HDsZLUuvTqcl9nmnrgDa6L2RffEmLA/edit?usp=sharing) for the course (google sheet), subject to change as we go. There will be a midterm to add once we know when it is. Specifically:
    ...
    - There is no tutorial in this course. Instead, I am expecting you to spend time on your own working through the week's [worksheet](https://ritsokiguess.site/STAD29/all_worksheets.html). Each worksheet should be available on Monday, and should make sense to you after the lecture for the week.
