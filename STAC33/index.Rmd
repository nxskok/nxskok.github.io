...
- 2024-04-19 21:55: the final exam has been scanned, and marking has begun. We are now at 11% done, which I think is mostly me so far. [My solutions](final-20241-c33-solutions-figures.pdf), with the Figures at the back if you need them.
...
- 2024-04-12 15:45: 
  ...
  - thank you to the student who alerted me to a missing video (the second part of Bayesian analysis). This is now on the [Quercus video page](https://q.utoronto.ca/courses/333288/pages/video-page), numbered as "lecture 12b" (we didn't do lecture 12c this time).
...
- 2024-04-04 21:00: there is now a [Worksheet 11](worksheet_11_c33.html) on Stan. I don't think this will run on `r.datatools`, so you'll need to be running this on R on your own machine. Reminder that there are no tutorials on Monday (Monday is a makeup day for classes that missed a day on Good Friday).
...
- 2024-04-04 15:10: the Stan code that I used in class. These may well download to your hard disk, and then you can do what you want with them:
  - [Poisson 1](http://ritsokiguess.site/lecture-notes/poisson1.stan)
  - [Poisson 2](http://ritsokiguess.site/lecture-notes/poisson2.stan)
  - [Jumping rats](http://ritsokiguess.site/lecture-notes/anova.stan)
...
- 2024-03-27 12:50: ok, a Wednesday update instead:
  - Assignment 8 was due on Sunday and closed yesterday night. [My solutions](a8_c33_2024.html). We are now done with assignments.
  - Lectures this week:
    - Tuesday: finish the asphalt case study plus regression with categorical variables (done)
    - Thursday: functions.
  - Extra practice problems: there will be a worksheet on this stuff for next week, also [PASIAS](https://ritsokiguess.site/pasias2/) chapters 19, 20, and 22. (PASIAS also has material on dates and times, which we won't do in this course.)
 
- 2024-03-22 12:45: [worksheet 9](worksheet_9_c33.html) for tutorial on Monday. The third question is on multiple regression; some of the things in it we sped through on Thursday or will not see until Tuesday next week.
...
- 2024-03-18 11:00: Monday update:
  - Tutorial today, featuring [Worksheet 8](worksheet_8_c33.html).
...
- 2024-03-15 12:45:
  ...
  -   [Worksheet 8](worksheet_8_c33.html) for tutorial on Monday. This will prepare you for Assignment 8, which opens on Monday night.
...
-   2024-03-13 11:20: my solutions to [assignment 6](a6_c33_2024.html).
...
-   2024-03-09 21:30: the end is in sight: the midterm is now 90% marked. I had a totally thrilling day getting the marking done that I assigned to myself on this exam, and I am now done. I'm not sure I shared [my solutions](midterm-20241-c33-answers.pdf), which are updated with extra comments on the bits that I marked.

-   2024-03-08 21:15: two updates:
  ...
  -   there is tutorial on Monday, in which you'll be working on [this worksheet](worksheet_7_c33.html), which will prepare you for Assignment 7 (that opens on Monday night).
...
-   2024-03-05 13:30: the [blog post about Tukey's method](https://ritsokiguess.site/blogg/posts/2024-02-29-honestly-significant-differences/) that I mentioned in lecture, if you want more background.
...
-   2024-03-04 11:00: Monday update:
  ...
  -   reminder that there are *no tutorials* today. If you have not yet worked through [worksheet 6](worksheet_6_c33.html), now would be a good time to do so, in preparation for Assignment 6 (which is due next Sunday night).
  -   lectures this week:
        -   Tuesday: the rest of analysis of variance
        -   Thursday: tidying data
    -   extra practice problems in [PASIAS](https://ritsokiguess.site/pasias2/): chapter 13 (analysis of variance), chapter 17 (tidying data). The intervening chapters are on writing reports, on which there is [lecture material](https://ritsokiguess.site/lecture-notes/reports.html), but I won't be talking about that this time.

-   2024-03-01 12:20:

    -   my solutions to [Assignment 5](a5_c33_2024.html)
