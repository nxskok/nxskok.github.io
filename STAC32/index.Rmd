...
- 2024-02-03 14:00: Happy new year, all! It appears that the course grades are up on ROSI (as of this morning). 

  - A reminder that course grades are final, and that I am not allowed to discuss or negotiate them. 

  - I plan to share your graded final exam with you shortly; this is *for your information only*, and I will not discuss the marking of the final exam. You will receive an email from Crowdmark with instructions for accessing it. [My solutions](final-20239-c32-solutions.pdf). If you think there is an error in the calculation of your grade or the marking of your final exam, you *must* go through the Registrar's office and their procedures.

  - If you did not pass the course, it is because you did not come close to passing the final exam and in most cases did not even get close to 40% (I checked), and thus you did not come close to displaying the level of knowledge or understanding that I expect in this course. (The final exam was written in such a way that a student aiming for 50 had every opportunity to display that they had that much knowledge). If you are in that position, you had your opportunity; you will need to take the course again next fall. There are no other ways to complete the program.
  
  - If you are tempted to email me about your grade: don't. Re-read the above, and the note below about what course grades are based on.
  
  - To those that made it through: congratulations, and I look forward to seeing you again in D29 next week.


- 2023-12-26 16:30: Hope you are enjoying whatever it may be that you are celebrating (which might be some well-deserved rest), and I wish you a happy new year. Our final exam is graded, and I am about to submit the course grades that you earned. Before I do that, though, some things I need to say:
  - To calculate your course grade: 
    - I turn each assignment mark into a percentage, find the top 6 of those, and take the mean of them.
    - I turn the midterm and final exam marks into percentages (out of 57 and 99 respectively).
    - I calculate course grades by two schemes: the one announced in the syllabus, and counting the final exam in place of the midterm (for everyone, whether you wrote the midterm or not). You automatically get whichever scheme gives you the higher course grade.
    - If you get less than 40% on the final exam but would otherwise have passed, your course grade is 45.
    - 0.5 and above is rounded up; below that is rounded down.
  - Course grades need to be be submitted and approved before they reach you. I don't know how much human intervention that requires, but it may be that you don't get your course grades until the university re-opens in January.
  - Some of the work done on the final exam was very good, and there will be several A+ grades.
  - We were, for the most part, generous in marking the final exam.
  - I have reviewed grades close to key grade boundaries and am happy that I have things in the right places.
  - If you are under investigation for an academic offence in this course, your grade is GWR until the investigation is concluded.
  - Course grades are based *only* on the work you have done and the understanding you have displayed. Your personal circumstances do not, and cannot, figure into your grade. It does not matter how hard you worked, or that you need a certain grade for a scholarship or to graduate. If you want those things, it is up to *you* to do work of sufficient quality to earn them.
  - If you don't like your grade, you have exactly two options: a [clerical check](https://www.utsc.utoronto.ca/registrar/clerical-check) and, after obtaining a copy of your marked exam, a [petition for re-reading of your final exam](https://www.utsc.utoronto.ca/registrar/re-read-petitions). If you file this petition, I have the right to re-grade your entire exam, and I may find places where the grading has been too generous.
  - There is no extra credit. See [detailed course policies](policies.pdf), item 5.3.
...
- 2023-12-21 21:15: we are now 82% done. What remains is mostly question 4 and some odd other things. I think I am done marking.

- 2023-12-20 21:50: today's progress report: 69% done as I write. Question 1 is done, 2 is done apart from (g), 3 is underway, half of 5 is done, question 6 is done (by me, today), and 7 is about half done. [My solutions](final-20239-c32-solutions.pdf) as amended today.   

- 2023-12-19 23:00: progress report: 42% done. This includes almost all of question 1, almost all of question 2, and most of the other odd bits that I gave myself to grade. I have to tackle question 6 tomorrow, along with one bit of question 7 that I forgot.

- 2023-12-18 22:30: we have a scanned exam, and grading has begun. We are 18% done: part of questions 1 and 2, and my two parts of question 7. (I wanted to get warmed up with something easier to grade.) I am about done for tonight, and will get back to it tomorrow. [My solutions](final-20239-c32-solutions.pdf), with the Figures at the end.

- 2023-12-18 14:05: Our final exam, like the midterm, is a Crowdmark exam, so it needs to be scanned first, and then we can grade it (online). There were several exams on Saturday that will need to be scanned, so we will have to wait our turn. After that, the grading can start. Expect to see occasional updates here on our progress.

- 2023-12-14 14:10: a reminder that our final exam is on Saturday morning at 9:00am. See [the Quercus announcement](https://q.utoronto.ca/courses/313623/discussion_topics/2420761) for where to be.
