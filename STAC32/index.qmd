...
- 2025-11-13 11:00: My solutions to Assigment 6 and Worksheet 9 are up on the [assignment solutions page](all_assignments.qmd) and the [worksheets page](all_worksheets.qmd) respectively. Added 21:30: Worksheet 10, for next week's tutorial, is also up.

- 2025-11-10 11:15: Monday update:
  - Assignment 4 is marked. I will release the marks shortly. Appeals by usual procedure between Nov 13 and Nov 20 only. (The TA had computer problems, which are now hopefully fixed.)
  - Assignment 6 is due tonight, and closes on Wednesday.
  - Lectures: we go on to regression, with two case studies:
    - [Windmill](http://ritsokiguess.site/lecture-notes/windmill.html), simple regression
    - [Asphalt](http://ritsokiguess.site/lecture-notes/asphalt.html), multiple regression
    - I also have a piece on [regression with categorical variables](http://ritsokiguess.site/lecture-notes/with_categ.html), but it is likely that we won't get to that until next week.
  - Worksheet 9, for tutorial on Wednesday, is up on the [worksheets page](all_worksheets.qmd), with two problems on tidying data.
  - Assignment 7, on the same material as Worksheet 9, opens on Wed night.

- 2025-11-07 22:00: in case you want to start on it, next week's Worksheet 9 is up on the  [worksheets page](all_worksheets.qmd). I changed my mind about what was going to be on Worksheet 9 (and thus next week's Assignment 7), adding an extra question to the worksheet to give you some more practice.

- 2025-11-06 11:00: 
  - my solutions to Assignment 5, which closed yesterday, are up on the [assignment solutions page](all_assignments.qmd).
  - my solutions to Worksheet 8, for tutorial yesterday, are up on the [worksheets page](all_worksheets.qmd).


- 2025-10-30 12:50: a rather early "Monday update", with nothing in it to worry about until next week (so you can enjoy the rest of your reading week):
  - assignment 5 is due on Nov 3
  - lectures: the rest of tidying (that is, [tidying data](http://ritsokiguess.site/lecture-notes/tidying.html), [tidying extras](http://ritsokiguess.site/lecture-notes/tidy_extra.html), [when pivot-wider goes wrong](http://ritsokiguess.site/lecture-notes/wider_wrong.html))
  - worksheet 8 for tutorial on Nov 5 is on the [worksheets page](all_worksheets.qmd). Some of it may make more sense after Tuesday's lecture.
  - assignment 6 (on the same material as worksheet 8: the numbering is off by 2 now) will open on Wed night.

- 2025-10-27 13:45: reminder: Reading week, no lectures, tutorials, or assignments due.
